defmodule Exa.Space.Vec2f do
  ...
  It is an error for the length to be less than tolerance.
  """
  ...
  @doc """
  Get the unsigned angle between the vectors. 
  ...
  """
  @spec sgn_angle_deg(S.vec2f(), S.vec2f(), E.epsilon()) ::
          {S.orientation(), E.degrees()} | :degenerate
  def sgn_angle_deg(v1, v2, eps \\ @epsilon) when is_vec2f(v1) and is_vec2f(v2) do
  ...
  """
  @spec move(S.vec2f(), S.pos2f()) :: S.vec2f()
